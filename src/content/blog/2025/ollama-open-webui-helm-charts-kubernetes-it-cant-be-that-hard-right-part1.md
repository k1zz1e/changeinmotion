...
![](/images/posts/2025/11/ollama-helm-site.avif)

Run a few magic commands and presto!

![](/images/posts/2025/11/ollama-helm-chart-install.avif)
...
![](/images/posts/2025/11/kubectl-get-all-ollama.avif)
...
## Note: you can log in to pods with a shell via this command:  
```
kubectl exec -it -n ollama pod/ollama-75d5ccbd95-jq7wr -- /bin/sh
```

![](/images/posts/2025/11/Artifact-HUB-OpenWEBUI.avif)
...
![](/images/posts/2025/11/OPEN-WEBUI-Welcome.avif)
...
![](/images/posts/2025/11/Firefox-Unable-to-Connect.avif)
...
![](/images/posts/2025/11/Open-WebUI-pod-failure.avif)
...
## Welcome to DevOPs! Where failure is a stepping stone to success!
It's time to start digging.  Since we already know the name of the two pods that have failed to run we need to see what is going on with them specifically:
...
![](/images/posts/2025/11/kubectl-describe-open-webui.avif)
...
![](/images/posts/2025/11/Synology-SAN-Manager.avif)
...
![](/images/posts/2025/11/Synology-csi-Uninstall-Script.avif)

Now let's reinstall synology-csi:

![](/images/posts/2025/11/Deploy-synology-csi.avif)
...
![](/images/posts/2025/11/synology-csi-install-check.avif)
